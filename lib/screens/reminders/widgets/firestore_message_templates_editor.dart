// lib/widgets/reminders/firestore_message_templates_editor.dart

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:agenda_fisio_spa_kym/theme/theme.dart';

class FirestoreMessageTemplatesEditor extends StatefulWidget {
  final String tipoUsuario;
  const FirestoreMessageTemplatesEditor({Key? key, required this.tipoUsuario})
      : super(key: key);

  @override
  State<FirestoreMessageTemplatesEditor> createState() =>
      _FirestoreMessageTemplatesEditorState();
}

class _FirestoreMessageTemplatesEditorState
    extends State<FirestoreMessageTemplatesEditor> {
  ...
  Future<void> _eliminarMensaje(String estado) async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
            '¿Seguro que deseas eliminar la plantilla del estado "$estado"?'),
        actions: [
          TextButton(
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
          ...
          children: [
            Wrap(
              ...
              children: sugeridos.map((e) {
                return InputChip(
                  label: Text(e),
                  onPressed: () => nuevoController.text = e,
                );
              }).toList(),
            ),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              final estado = nuevoController.text.trim();
      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Plantillas para ${widget.tipoUsuario[0].toUpperCase()}${widget.tipoUsuario.substring(1)} / WhatsApp',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            buildVariablesHelpChips(),
                            const SizedBox(height: 8),
                            TextButton.icon(
                              onPressed: () => showVistaPreviaDialog(
  ...
  Widget buildVariablesHelpChips() {
    const variables = [
      '{{nombre}}',
      '{{fecha}}',
      '{{hora}}',
  ...
  void showVistaPreviaDialog(BuildContext context, String template) {
    const ejemplo = {
      'nombre': 'Andrea',
      'fecha': '20 de abril',
      'hora': '13:00',
